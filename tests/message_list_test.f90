...
contains
    ...
    function checkAppendToEmpty() result(result_)
        ...
        call message_list%appendMessage(Info( &
                Module_("Some_m"), Procedure_("some"), MESSAGE))
    ...
    function checkAppendMultipleToEmpty() result(result_)
        ...
        call message_list2%appendMessage(Info( &
                Module_("Some_m"), Procedure_("some"), FIRST_MESSAGE))
        call message_list2%appendMessage(Warning( &
                Module_("Some_m"), Procedure_("some"), SECOND_MESSAGE))

        call message_list1%appendMessages(message_list2)
